...
function renderFusionResult(d) {
  ...
  el.innerHTML = `
    ...
    <div class="prob-grid">
      ...
      ${d.model1_overall !== null ? probBar('🏥 Model 1: Clinical (SEER)', d.model1_overall, 'AUROC 0.736') : ''}
      ${d.model2 !== null ? probBar('🧬 Model 2: Genomic (TCGA)', d.model2, 'AUROC 0.897 · Recall 83.3%') : ''}
      ${d.model3 !== null ? probBar('☢️ Model 3: Imaging (TCGA)', d.model3, 'AUROC 0.928 · Recall 83.3%') : ''}
    </div>
